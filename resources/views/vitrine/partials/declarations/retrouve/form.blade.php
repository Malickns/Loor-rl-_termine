<div class="container">
    <div class="form-section">
        <h2>Formulaire de déclaration de bien retrouvé</h2>
    
        <div class="progress">
            <div class="progress-bar bg-success" role="progressbar" style="width: 0%"></div>
        </div>
        <form id="foundItemForm" class="needs-validation" novalidate method="POST" action="ajouter/traitement" enctype="multipart/form-data">
            @csrf
            <div class="row g-4">
                <!-- Informations sur l'objet -->
                <div class="col-md-6">
                    <label class="form-label">Titre de l'annonce *</label>
                    <input type="text" class="form-control" name="titre" placeholder="Exemple : Clé retrouvée à Dakar" required>
                </div>
                <div class="col-md-6"> 
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="description" rows="4" placeholder="Décrivez le bien retrouvé..." required></textarea>
                </div>
                ...
                <!-- Informations sur le bien retrouvé -->
                <div class="col-md-6">
                    <label class="form-label">Lieu où le bien a été retrouvé *</label>
                ...
                <div class="col-12">
                    <div class="image-upload" id="dropZone">
                        ...
                        <h5>Déposez une image du bien ici</h5>
                        <p class="text-muted">ou</p>
                        <button type="button" class="btn btn-outline-success" id="uploadButton">
